      ...
      <>
            ...
            <div className="row">
              <div className="col-md-7">
                <div className="" style={{ marginLeft: "-178p" }}>
                  ...
                  <p style={{ padding: "0" }}>
                    Are you getting stuck in store management&#63; Are you
                    getting stuck in managing business&#63;
                  </p>
                  <p style={{ padding: "0" }}>
        ...
        <section className={Styles.mydiv88}>
          <div className="container">
            ...
            <p className={Styles.paddingSide}>
              Manage all your stores&#44; plants&#44; staff and services under
              one roof &#33; Take advantage of multistore features to accelerate
              your business&#44; increase your productivity and elevate your
              profits.
            </p>
            <h4 className={Styles.titile_box}>
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="" style={{ marginLeft: "-178p" }}>
                  ...
                  <p style={{ padding: "0" }}>
                    If you run a central cleaning facility&#44; we provide a
                    plant mode feature in the software&#44; where staff at the
                    plant can manage order from multi stores.
                  </p>
                  <br />
                  <p style={{ padding: "0" }}>
        ...
        <section className={Styles.mydiv88}>
          <div className="container">
            ...
            <p className={Styles.paddingSide}>
              Manage all your stores&#44; plants&#44; staff and services under
              one roof &#33; Take advantage of multi-store features to
              accelerate your business&#44; increase your productivity and
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                ...
                <p style={{ padding: "0" }}>
                  ...
                  revenue and minimize stress for you. All you have to do
                  is&#44; Try E&#45;Laundry and take your business to higher
                  level.
                </p>
              </div>
            </div>
